...
export const LogEvent = {
  ...
  PULSERTC_CONNECTING: 'PULSERTC_CONNECTING',
  PULSERTC_ROOM_JOINED: 'PULSERTC_ROOM_JOINED',
  PULSERTC_DISCONNECTED: 'PULSERTC_DISCONNECTED',
  PULSERTC_CONNECTION_FAILED: 'PULSERTC_CONNECTION_FAILED',
  PULSERTC_SCREEN_SHARE_STARTED: 'PULSERTC_SCREEN_SHARE_STARTED',
  PULSERTC_SCREEN_SHARE_STOPPED: 'PULSERTC_SCREEN_SHARE_STOPPED',
